      ...
      child: Column(
        children: [
              ...
              SizedBox(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                      hintText: "*",
                      hintStyle: const TextStyle(color: Color.fromARGB(255, 193, 189, 189)),
                      border: authOutlineInputBorder,
                      enabledBorder: authOutlineInputBorder,
                      focusedBorder: authOutlineInputBorder.copyWith(
                          borderSide:
                          const BorderSide(color: Color.fromARGB(255, 14, 7, 1)))),
                ),
              ),
              SizedBox(
                height: 64,
              ...
              SizedBox(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                      ...
                      focusedBorder: authOutlineInputBorder.copyWith(
                          borderSide:
                          const BorderSide(color: Color.fromARGB(255, 253, 252, 252)))),
                ),
              ),
              SizedBox(
                height: 64,
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                      ...
                      focusedBorder: authOutlineInputBorder.copyWith(
                          borderSide:
                          const BorderSide(color: Color.fromARGB(255, 252, 251, 251)))),
                ),
              ),
            ],
          ),
          ...
          CustomButton(onPressed: (){
            Get.to(New_Password());
          }, text: "Confirm", color:Color(0xFF4A3298), txtcolor: Colors.white),
